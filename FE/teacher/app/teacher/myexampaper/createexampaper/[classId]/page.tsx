  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100">
      <div className="max-w-7xl mx-auto py-8 px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-8">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-3">
              ...
              <div>
                <h1 className="text-3xl font-bold text-gray-900">Tạo đề thi tự luận</h1>
                <p className="text-gray-600">Thiết lập và cấu hình đề thi tự luận cho lớp học</p>
              </div>
            </div>
            ...
            <div className="bg-white rounded-xl shadow-lg p-6">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-2xl font-bold text-blue-600">{selectedQuestions.length + manualQuestions.length}</p>
                </div>
            ...
            <div className="bg-white rounded-xl shadow-lg p-6">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className={`text-2xl font-bold ${totalScore === 10 ? 'text-green-600' : 'text-red-600'}`}>
                    {totalScore}/10
                  </p>
                  {totalScore !== 10 && (
                    <p className="text-red-500 text-xs mt-1">Phải bằng 10 điểm</p>
                  )}
                </div>
        ...
        {/* Warning message when total score is not 10 */}
        {(selectedQuestions.length > 0 || manualQuestions.length > 0) && totalScore !== 10 && (
          <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4 mb-6">
            <div className="flex items-center space-x-2">
              <AlertCircle className="w-5 h-5 text-yellow-600" />
              <span className="text-yellow-800 font-medium">
                Cảnh báo: Tổng điểm hiện tại là {totalScore}/10. Vui lòng điều chỉnh để tổng điểm bằng 10!
              </span>
            </div>
          </div>
        )}
          ...
          <div className="bg-white rounded-xl shadow-lg p-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                ...
                <select
                  value={selectedGradeComponent?.value || ''}
                  onChange={e => {
                    const val = Number(e.target.value);
                    setSelectedGradeComponent(val ? gradeComponents.find(g => g.value === val) || null : null);
                  }}
            ...
            <div className="bg-white rounded-xl shadow-lg overflow-hidden">
              ...
              <div className="px-6 py-4 border-t border-gray-200 bg-gray-50">
                <div className="flex items-center justify-between">
                  ...
                  <button
                    type="submit"
                    disabled={isSubmitting || !inputName || !selectedGradeComponent || (selectedQuestions.length + manualQuestions.length) === 0 || totalScore !== 10}
