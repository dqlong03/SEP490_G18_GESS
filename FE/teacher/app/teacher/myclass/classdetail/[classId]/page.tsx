...
import { useClassDetail } from "@/hooks/teacher/useClassDetail";
import { Student, Exam } from "@/services/teacher/classDetailService";
...
export default function ClassDetailPage({ params }: ClassDetailPageProps) {
  ...
  // Render grading badge component
  const renderGradingBadge = (isGraded: string) => {
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 overflow-hidden">
      <div className="max-w-full mx-auto py-4 px-2 sm:px-4 lg:px-6">
          ...
          <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <p className="text-gray-600 text-sm sm:text-base">{className || `Lớp ${classId}`}</p>
              </div>
            </div>
            
            <button
              onClick={() => setShowStudentList(true)}
              className="flex items-center space-x-2 px-4 mx-10 py-2 sm:px-6 sm:py-3 bg-gradient-to-r from-blue-600 to-indigo-600 text-white rounded-xl font-semibold hover:from-blue-700 hover:to-indigo-700 transition-all duration-200 shadow-lg hover:shadow-xl text-sm sm:text-base"
            >
              <svg className="w-4 h-4 sm:w-5 sm:h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z" />
              </svg>
              <span className="hidden sm:inline">Quản lý sinh viên</span>
              <span className="sm:hidden">QL sinh viên</span>
            </button>
          </div>
        </div>
        ...
        {showStudentList ? (
            ...
            <div className="overflow-x-auto">
              <table className="min-w-full divide-y divide-gray-200">
                ...
                <tbody className="bg-white divide-y divide-gray-200">
                  {filteredStudents.map((sv: Student, idx: number) => (
                  ...
                  <tr className="bg-blue-50">
                    ...
                    <td className="px-6 py-4 whitespace-nowrap">
                      <input
                        ...
                        onChange={(e) => setNewStudent((s: typeof newStudent) => ({ ...s, code: e.target.value }))}
                      />
                    </td>
                    <td className="px-6 py-4 whitespace-nowrap">
                      <input
                        ...
                        onChange={(e) => setNewStudent((s: typeof newStudent) => ({ ...s, name: e.target.value }))}
                      />
                    </td>
                    <td className="px-6 py-4 whitespace-nowrap">
                      <input
                        ...
                        onChange={(e) => setNewStudent((s: typeof newStudent) => ({ ...s, avatarURL: e.target.value }))}
                      />
                    </td>
                  </tr>
                </tbody>
          ...
          /* Exams List Section */
          <div className="bg-white rounded-xl shadow-lg mx-0">
            <div className="px-6 py-4 border-b border-gray-200">
              <div className="flex items-center justify-between">
                <h3 className="text-lg font-semibold text-gray-800 flex items-center">
                  <svg className="w-5 h-5 mr-2 text-blue-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div className="relative">
                  <button
                    ...
                    className="flex items-center space-x-2 px-6 mx-5.5 py-3 bg-gradient-to-r from-green-600 to-emerald-600 text-white rounded-xl font-semibold hover:from-green-700 hover:to-emerald-700 transition-all duration-200 shadow-lg hover:shadow-xl"
                  >
                    ...
                    <div className="absolute right-0 mt-2 w-56 bg-white border border-gray-200 rounded-xl shadow-xl z-10 overflow-hidden">
                      <button
                        onClick={() => {
                          ...
                          router.push(`/teacher/myexam/createmulexam/${classId}`);
                        }}
                      ...
                      <button
                        onClick={() => {
                          setShowExamOptions(false);
                          router.push(`/teacher/myexam/createpracexam/${classId}`);
                        }}
                        className="w-full flex items-center space-x-3 px-4 py-3 hover:bg-blue-50 text-gray-700 font-medium transition-colors duration-200"
                      >
            ...
            {loading ? (
              ...
              <div className="overflow-x-auto">
                <table className="min-w-full divide-y divide-gray-200">
                  ...
                  <tbody className="bg-white divide-y divide-gray-200">
                    {filteredExams.map((item: Exam, idx: number) => (
                      <tr key={`${item.examId}-${item.examName}`} className="hover:bg-blue-50 transition-colors duration-200">
                        ...
                        <td className="px-6 py-4 whitespace-nowrap text-center">
                          {renderGradingBadge(item.isGraded)}
                        </td>
                        <td className="px-6 py-4 whitespace-nowrap text-center">
