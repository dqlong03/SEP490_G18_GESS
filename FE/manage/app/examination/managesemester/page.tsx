                  ...
                  <form onSubmit={handleSubmit} className="space-y-6">
                    <div className="space-y-5">
                      ...
                      {fields.map((field, index) => (
                        <div key={field.id} className="bg-gradient-to-r from-gray-50 to-blue-50 rounded-xl p-5 border border-gray-200">
                    ...
                    <div className="pt-6 border-t border-gray-200">
                      <button
                        type="submit"
                        disabled={isLoading}
                        className="w-full bg-gradient-to-r from-indigo-600 to-purple-600 hover:from-indigo-700 hover:to-purple-700 disabled:from-gray-400 disabled:to-gray-500 text-white font-bold py-4 rounded-xl transition-all duration-200 shadow-lg hover:shadow-xl flex items-center justify-center gap-3"
                      >
                        {isLoading ? (
                          <>
            ...
            <div className="lg:col-span-1 space-y-6">
              ...
              <div className="bg-gradient-to-br from-blue-50 to-indigo-50 border border-blue-200 rounded-2xl p-6 shadow-md">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h4 className="font-bold text-blue-800 mb-3 text-lg">Lưu ý quan trọng</h4>
                    <ul className="text-blue-700 space-y-2">
                      <li className="flex items-start gap-2">
                        <span className="w-2 h-2 bg-blue-500 rounded-full mt-2 flex-shrink-0"></span>
                        <span>Thay đổi cấu hình học kỳ sẽ ảnh hưởng đến toàn bộ hệ thống</span>
                      </li>
                      <li className="flex items-start gap-2">
                        <span className="w-2 h-2 bg-blue-500 rounded-full mt-2 flex-shrink-0"></span>
                        <span>Đảm bảo tên học kỳ rõ ràng và dễ hiểu</span>
                      </li>
                      <li className="flex items-start gap-2">
                        <span className="w-2 h-2 bg-blue-500 rounded-full mt-2 flex-shrink-0"></span>
                        <span>Nên bao gồm năm học trong tên để dễ phân biệt</span>
                      </li>
                    </ul>
                  </div>
                </div>
              ...
              <div className="bg-gradient-to-br from-green-50 to-emerald-50 border border-green-200 rounded-2xl p-6 shadow-md">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h4 className="font-bold text-green-800 mb-3 text-lg">Hướng dẫn</h4>
                    <ul className="text-green-700 space-y-2">
                      <li className="flex items-start gap-2">
                        <span className="w-2 h-2 bg-green-500 rounded-full mt-2 flex-shrink-0"></span>
                        <span>Chọn số lượng học kỳ từ dropdown</span>
                      </li>
                      <li className="flex items-start gap-2">
                        <span className="w-2 h-2 bg-green-500 rounded-full mt-2 flex-shrink-0"></span>
                        <span>Nhập tên cho từng học kỳ</span>
                      </li>
                      <li className="flex items-start gap-2">
                        <span className="w-2 h-2 bg-green-500 rounded-full mt-2 flex-shrink-0"></span>
                        <span>Bấm "Lưu cấu hình" để hoàn tất</span>
                      </li>
                    </ul>
                  </div>
                </div>
              ...
              <div className="bg-gradient-to-br from-amber-50 to-orange-50 border border-amber-200 rounded-2xl p-6 shadow-md">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h4 className="font-bold text-amber-800 mb-3 text-lg">Gợi ý đặt tên</h4>
                    <ul className="text-amber-700 space-y-2 text-sm">
                      <li><strong>Ví dụ 1:</strong> "Học kỳ 1 năm 2024-2025"</li>
                      <li><strong>Ví dụ 2:</strong> "HK1 2024-2025"</li>
                      <li><strong>Ví dụ 3:</strong> "Semester 1 - 2024"</li>
                    </ul>
                  </div>
                </div>
              </div>
